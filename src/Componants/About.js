...
export default function About() {
    ...
    const [btnTaxt, setbtnTaxt] = useState("Elable Dark mode");
...
<button className=" my-3 btn btn-primary mx-1" onClick={toggelStyle}>{btnTaxt}</button>
        </div>
    )
}
